export default {
  editor: {
    ...
    customStylePropertiesOrder: [
      ...
      [
        ...
        "pinnedRowTextColor",
        "pinnedRowBold",
        "pinnedRowBorderTop",      // NEW (optional)
        "pinnedRowFontSize",       // NEW (optional)
        "pinnedRowOpacity",        // NEW (optional)
        "pinnedRowPadding",        // NEW (optional)
      ],
      [
        "rowTitle",
        "rowBackgroundColor",
  ...
  properties: {
    pinnedBottomRows: {
      ...
      bindingValidation: {
        type: "array",
        tooltip: "An array of objects for pinned bottom rows",
      }
    },
    pinnedRowBackground: {
      label: { en: "Pinned Row Background" },
      type: "Color",
      bindable: true,
      section: "style",
    ...
    pinnedRowTextColor: {
      label: { en: "Pinned Row Text Color" },
      type: "Color",
      bindable: true,
      section: "style",
      options: { nullable: true },
    ...
    pinnedRowBold: {
      label: { en: "Pinned Row Bold Text" },
      type: "OnOff",
      defaultValue: true,
      bindable: true,
      section: "style",
    },
    // ===== PASTE HERE: extra (optional) pinned-row style props =====
    pinnedRowBorderTop: {
      label: { en: "Pinned Row Top Border" },
      type: "Border",
      bindable: true,
      section: "style",
      options: { nullable: true },
    ...
    pinnedRowOpacity: {
      label: { en: "Pinned Row Opacity" },
      type: "Number",
      section: "style",
      options: { min: 0, max: 1, step: 0.05, noRange: true },
      bindable: true,
    },
    pinnedRowPadding: {
      label: { en: "Pinned Row Padding" },
      type: "Spacing",
      section: "style",
      bindable: true,
    },
        ...
        item: {
          ...
          options: (
            ...
            item: {
              ...
              // ===== PASTE HERE: Pinned-bottom (per-column) controls for custom cells =====
              pinnedBottomTitle: {
                type: "Title",
                label: "Pinned Bottom Row",
                editorOnly: true,
                hidden: (array) => array?.item?.cellDataType !== "custom",
              },
              usePinnedBottomContainer: {
                label: "Use separate pinned container",
                type: "OnOff",
                defaultValue: false,
                hidden: (array) => array?.item?.cellDataType !== "custom",
                bindable: true,
              ...
              pinnedBottomInfo: {
                ...
                options: {
                  variant: "tip",
                  content:
                    "When enabled, a dedicated element (container) is used for pinned bottom cells. Select or design it from the Layout view.",
                },
                editorOnly: true,
                hidden: (array) =>
                  array?.item?.cellDataType !== "custom" || !array?.item?.usePinnedBottomContainer,
              },

              // Store the container id (created in code). Hidden from the UI.
              // We keep it to make the column object persist the reference.
              pinnedBottomContainerId: {
                label: "Pinned Bottom Container Id",
                type: "Text",
                editorOnly: true,
                hidden: true,
              },

              // (Optional) simple aggregation helpers for the pinned row
              pinnedAgg: {
                label: "Pinned Value",
                type: "TextSelect",
                options: {
              ...
              pinnedAggField: {
                label: "Pinned Value Field",
                type: "Text",
                placeholder: "Leave empty to use this column's field",
                hidden: (array) =>
                  array?.item?.cellDataType !== "custom" ||
                  ["count", "none"].includes(array?.item?.pinnedAgg || "none"),
                bindable: true,
              },
              // ===== END PASTE =====
              align: {
